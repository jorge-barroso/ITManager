...
AWS::S3Manager::S3Manager(std::string const& accessKey, std::string const& secretAccessKey, Regions::Region const& region) : regionName(Aws::Utils::StringUtils::to_string(Regions::toString(region)))
{
